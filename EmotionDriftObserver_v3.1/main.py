...
def pipeline(context):
    ...
    updates = load_tagged_data(data_root)
    new_count = update_validation_set(data_root, validation_path, sample_frac=0.05, max_samples=500)
    # old_acc and new_acc should be computed around validation run
